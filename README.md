# 🎈 Chirpy Lite - Premium Minimalist Blog Template
...
- **`assets/img/`** – Drop your custom profile photo or brand icon here named as `logo.png` to automatically replace the avatar.
